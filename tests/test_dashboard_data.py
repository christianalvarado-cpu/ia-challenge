...
def test_build_dashboard_payload_aggregates_required_components():
    df = pd.DataFrame(
        [
            {"sale_date": "2025-06-01", "subtotal": 10.0, "shop_name": "Shop A", "product_name": "Prod 1"},
            {"sale_date": "2025-06-02", "subtotal": 20.5, "shop_name": "Shop A", "product_name": "Prod 2"},
            {"sale_date": "2025-06-02", "subtotal": 5.25, "shop_name": None, "product_name": "Prod 1"},
        ]
    )
...
def test_render_dashboard_html_embeds_data_and_chart_ids():
    payload = {
        "metadata": {"generated_at": "2026-01-01T00:00:00+00:00", "source_dataset": "data/analytics/comercial", "row_count": 1},
        "kpis": {"total_sold": 10.0, "total_rows": 1, "date_start": "2025-06-01", "date_end": "2025-06-01"},
